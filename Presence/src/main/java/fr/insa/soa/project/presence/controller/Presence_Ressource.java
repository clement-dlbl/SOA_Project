...
import fr.insa.soa.project.presence.sensor.Presence;
...
@RestController
public class Presence_Ressource {
	...
	@GetMapping("/rooms/{name}/sensors/alarm")
	public Presence retrieve_OM2M(@PathVariable String name) throws IOException, XPathExpressionException {
		Client client = new Client();
		Presence alarm_sens = new Presence();
