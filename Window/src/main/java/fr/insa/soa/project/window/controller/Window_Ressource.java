...
import fr.insa.soa.project.window.sensor.Window;
...
public class Window_Ressource {
	...
	@GetMapping("/rooms/{name}/sensors/alarm")
	public Window retrieve_OM2M(@PathVariable String name) throws IOException, XPathExpressionException {
		Client client = new Client();
		Window alarm_sens = new Window();
